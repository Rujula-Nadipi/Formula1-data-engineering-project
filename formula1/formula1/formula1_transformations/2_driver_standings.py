...
# MAGIC %md
# MAGIC Partition is based on race_year in here and so, we will need to go along with it by adding a slightly different approach.
...
# MAGIC %md
# MAGIC Find the race year for which the data needs to be reprocessed.
...
delta_partition_path = f"{presentation_folder_path}/driver_standings"
...
results_after_df = spark.read.format("delta").load(f"{presentation_folder_path}/driver_standings")
