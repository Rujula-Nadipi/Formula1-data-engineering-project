...
spark.sql(f"""
            ...
            JOIN f1_processed.races1 ON (results.race_id = races1.race_id)
...
spark.sql(f"""
            ...
            WHEN NOT MATCHED 
            THEN INSERT (race_year, team_name, driver_id, driver_name, race_id, position, points, created_date)
            VALUES (race_year, team_name, driver_id, driver_name, race_id, position, points, current_timestamp)
  """)
